    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-slate-800/50 rounded-xl border border-slate-700/50 p-6 mb-6">
        ...
        <p className="text-slate-400 mb-4">
          Export your team's knowledge base as a PDF document. Includes decisions, tasks, knowledge entries, and more.
        </p>
        
        <div className="flex items-center gap-4">
          <ExportButton variant="primary" />
          <span className="text-sm text-slate-500">
            Download a comprehensive PDF export of your knowledge base
          </span>
        </div>
      </div>
